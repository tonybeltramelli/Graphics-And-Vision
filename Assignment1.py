...
def GetPupil(gray,thr):
    ...
    #Calculate blobs
    contours, hierarchy, c = cv2.findContours(binI, cv2.RETR_LIST, cv2.CHAIN_APPROX_SIMPLE)
    pupils = [];
...
def update(I):
    ...
    print("pupilThr :"+str(sliderVals['pupilThr']) + " glintThr :"+str(sliderVals['glintThr']))
